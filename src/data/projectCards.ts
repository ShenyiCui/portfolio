...
export const allProjects: Project[] = [
  {
    ...
    others: [{ title: 'Hackathon Link', link: 'https://appchallenge.singaporeair.com/en/challenges/students-2022' }],
    shields: ['https://img.shields.io/badge/2022-Winner%20%F0%9F%8F%86-yellow', 'https://img.shields.io/badge/2022-1st%20Place-success'],
  },
];
