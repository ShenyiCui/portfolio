  ...
  return (
    <div className='h-64 mt-8 flex justify-center'>
      <div className='h-full w-full max-w-7xl rounded-t-md bg-lightBlue flex flex-col items-center justify-center'>
        <h1 className='text-2xl font-montserrat font-bold'>Thanks for checking out my work!</h1>
        <h1 className='text-2xl font-montserrat font-bold text-darkBlue'>Let&apos;s Connect!</h1>
